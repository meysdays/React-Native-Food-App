...
import { CategoryCircle } from '@/components/shared';
...
const HomeScreen = () => {
  ...
  return (
    <View style={{paddingTop: top}} className='ml-3'>
      ...
      <View className=' flex-row  items-center my-4 '>
        ...
        <View>
          <View className='ml-3 flex-row items-center bg-[#FCE2CF80] px-3.5 py-4 rounded-2xl'>
            ...
            <CustomText style={{color: '#EA985B', fontSize:16}}>Order Now</CustomText>
          </View>
        </View>
      </View>
      ...
      <CategoryCircle selectedCategory={selectedCategory} onSelectCategory={setSelectedCategory} />
    </View>
  )
}
